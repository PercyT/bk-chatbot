<template>
    <div>
        <!--        <router-view v-if="h5" :key="routerKey" />-->
        <div id="app" :class="systemCls">
            <bk-navigation
                ...
                :default-open="false"
                @toggle="handleToggle" v-if="!h5">
                <template slot="side-icon">
                    <img src="../static/images/blue.png" class="header-icon" alt="">
                </template>
...
<script>
    ...
    export default {
        ...
        created () {
            ...
            this.getBiz()
            if (window.location.pathname.search('h5') !== -1 && window.location.pathname !== '/h5') {
        ...
        methods: {
            ...
            async getBiz () {
                try {
                    ...
                    this.$store.commit('updateBizList', this.header.selectList)
